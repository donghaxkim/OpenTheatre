...
func NewOpenTheatreService(roomExpireTime time.Duration) *OpenTheatreService {
	s := &OpenTheatreService{
...
type OpenTheatreService struct {
	config         Configuration
	rooms          sync.Map
...
func (s *OpenTheatreService) Timestamp() float64 {
	return float64(time.Now().UnixMilli()) / 1000
}
...
func (s *OpenTheatreService) GetRoomBackgroundUrl(ctx *VtContext, room string) string {
...
func (s *OpenTheatreService) GetAndCheckUpdatePermissionsOfRoom(ctx *VtContext, roomName, roomPassword string, userId string) (*Room, error) {
...
func (s *OpenTheatreService) CreateRoom(ctx *VtContext, name, password string, hostId string) *Room {
...
func (s *OpenTheatreService) QueryRoom(name string) *Room {
...
func (s *OpenTheatreService) Statistics() Statistics {
	return s.StatisticsN("")
}

func (s *OpenTheatreService) StatisticsN(pwd string) Statistics {
	var stat Statistics
